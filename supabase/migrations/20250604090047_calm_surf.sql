/*
  # Database Schema for Job Applications and Client Projects

  1. Tables
    - job_applications: Stores job application submissions
    - client_projects: Stores client project requests

  2. Security
    - RLS enabled on both tables
    - Policies for user access and admin management
    - Separate policies for viewing, inserting, and updating
